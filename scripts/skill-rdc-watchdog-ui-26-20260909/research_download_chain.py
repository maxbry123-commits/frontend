...
MANIFEST=DEST/'RESEARCH_DOWNLOAD_MANIFEST_WATCHDOG_UI_26_20260909.jsonl'; SPLIT_TARGET=12000000; MAX_ZIP=17*1000*1000; BATCH_LIMIT=90*1024*1024; CHUNK=8*1024*1024
REPOS=[('01','assistant-ui','https://github.com/assistant-ui/assistant-ui.git'),('02','tool-ui','https://github.com/assistant-ui/tool-ui.git'),('03','copilotkit','https://github.com/CopilotKit/CopilotKit.git'),('04','agent-ui','https://github.com/nyosegawa/agent-ui.git'),('05','xyflow','https://github.com/xyflow/xyflow.git'),('06','dnd-kit','https://github.com/clauderic/dnd-kit.git'),('07','fullcalendar','https://github.com/fullcalendar/fullcalendar.git'),('08','frappe-gantt','https://github.com/frappe/gantt.git'),('09','tanstack-table','https://github.com/TanStack/table.git'),('10','react-jsonschema-form','https://github.com/rjsf-team/react-jsonschema-form.git'),('11','xterm-js','https://github.com/xtermjs/xterm.js.git'),('12','monaco-editor','https://github.com/microsoft/monaco-editor.git'),('13','apache-echarts','https://github.com/apache/echarts.git'),('14','gpt-researcher-ui','https://github.com/assafelovic/gpt-researcher.git'),('15','mindsearch-ui','https://github.com/InternLM/MindSearch.git'),('16','deerflow-ui','https://github.com/bytedance/deer-flow.git'),('17','openhands','https://github.com/OpenHands/OpenHands.git'),('18','openwork','https://github.com/different-ai/openwork.git'),('19','opencowork','https://github.com/kairoslabs-ai/OpenCowork.git'),('20','useagent','https://github.com/useagenthq/useagent.git'),('21','interpreter-workstation','https://github.com/openinterpreter/interpreter-workstation.git'),('22','botroster','https://github.com/mandarwagh9/botroster.git'),('23','guaca','https://github.com/madebywelch/guaca.git'),('24','openbot','https://github.com/CopilotKit/OpenBot.git'),('25','cline','https://github.com/Cline/Cline.git'),('26','cowork','https://github.com/nomie7/cowork.git')]
...
commit(batch,f'{batch_no:03d}-final'); print('===== QUEUE COMPLETE: 26/26 repositories processed =====')
