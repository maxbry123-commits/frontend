...
MANIFEST=DEST/'RESEARCH_DOWNLOAD_MANIFEST_FABRICA_EMPAQUE_14_20260909.jsonl'; SPLIT_TARGET=12000000; MAX_ZIP=17*1000*1000; BATCH_LIMIT=90*1024*1024; CHUNK=8*1024*1024
REPOS=[('01','Tauri-2','https://github.com/tauri-apps/tauri.git'),('02','Capacitor','https://github.com/ionic-team/capacitor.git'),('03','PWABuilder','https://github.com/pwa-builder/PWABuilder.git'),('04','Workbox','https://github.com/GoogleChrome/workbox.git'),('05','Neutralino','https://github.com/neutralinojs/neutralinojs.git'),('06','Wails','https://github.com/wailsapp/wails.git'),('07','Bubblewrap-TWA','https://github.com/GoogleChromeLabs/bubblewrap.git'),('08','Dexie','https://github.com/dexie/Dexie.js.git'),('09','localForage','https://github.com/localForage/localForage.git'),('10','PouchDB','https://github.com/pouchdb/pouchdb.git'),('11','browser-fs-access','https://github.com/GoogleChromeLabs/browser-fs-access.git'),('12','Filesystem','https://github.com/ionic-team/capacitor-filesystem.git'),('13','capacitor-plugins','https://github.com/ionic-team/capacitor-plugins.git'),('14','capacitor-file-sharer','https://github.com/Cap-go/capacitor-file-sharer.git')]
...
commit(batch,f'{batch_no:03d}-final'); print('===== QUEUE COMPLETE: 14/14 repositories processed =====')
