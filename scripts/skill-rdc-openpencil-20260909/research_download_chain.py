...
MANIFEST=DEST/'RESEARCH_DOWNLOAD_MANIFEST_OPENPENCIL_20260909.jsonl'; SPLIT_TARGET=12000000; MAX_ZIP=17*1000*1000; BATCH_LIMIT=90*1024*1024; CHUNK=8*1024*1024
REPOS=[('01','OpenPencil','https://github.com/open-pencil/open-pencil.git')]
...
commit(batch,f'{batch_no:03d}-final'); print('===== QUEUE COMPLETE: 1/1 repositories processed =====')
