...
REPOS=[('01','Transformers.js','https://github.com/huggingface/transformers.js.git'),('02','MLC-WebLLM','https://github.com/mlc-ai/web-llm.git'),('03','ONNX-Runtime','https://github.com/microsoft/onnxruntime.git')]
...
print('===== QUEUE COMPLETE: 3/3 repositories processed =====')
