...
- Fallback prompt: "Use the Stitch DESIGN.md From Project skill without MCP. Follow the documented local or manual fallback, show the selected tool surface, and report the verification evidence."
