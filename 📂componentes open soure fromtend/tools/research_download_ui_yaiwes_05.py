...
REPOS=[('01','wllama','https://github.com/ngxson/wllama.git'),('02','LiteRT','https://github.com/google-ai-edge/LiteRT.git')]
...
print('===== QUEUE COMPLETE: 2/2 repositories processed =====')
