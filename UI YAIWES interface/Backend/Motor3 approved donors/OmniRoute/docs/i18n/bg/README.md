...
<img src="./docs/diagrams/readme-hero.svg" width="100%" alt="OmniRoute — Никога не спирайте да програмирате. Всеки AI инструмент → 359 доставчици — над 150 безплатни — чрез една крайна точка. Claude Code, Codex, Cursor, Cline, Copilot и Antigravity към БЕЗПЛАТНИ Claude / GPT / Gemini с автоматично превключване при отказ. Комбинираната компресия RTK + Caveman спестява 15–95% от токените (~89% средно) — никога не достигайте лимитите. 359 AI доставчици · над 150 безплатни нива · ~1,47 млрд. безплатни токена/месец · 19 стратегии за маршрутизиране · $0 за начало."/>

</div>

<div align="center">

## 💰 ~1,47 млрд. безплатни токена / месец

</div>

> Ръчното комбиниране на безплатни планове е мъчително — десетки SDK пакети, десетки ограничения на заявките и никаква представа с колко всъщност разполагате. OmniRoute каталогизира **452 записа за безплатни планове в 34 ключа за периодични споделени квоти** и изчислява общия брой токени въз основа на **16-те квоти с публикуван положителен месечен бюджет плюс пет лимита на Groq за отделни модели**, като премахва дублирането при споделените квоти. Квотите, които стават достъпни само след регионална проверка на самоличността (в момента: ModelScope), са показани отделно — още ~6 млн. след регионална проверка на самоличността — и никога не се включват в общата стойност. Резултатът остава видим в таблото (`/dashboard/free-tiers`).

<img src="./docs/diagrams/free-tier-budget.svg" width="100%" alt="Карта на бюджета за безплатните планове на OmniRoute: стабилно ~1,47 млрд. безплатни токена месечно и до ~2,07 млрд. през първия месец с кредитите при регистрация, от 34 документирани ключа за периодични споделени квоти, обхващащи 452 каталогизирани записа за безплатни планове зад една крайна точка. Честно изчисление с премахване на дублирането по споделени квоти — всяка споделена квота се отчита веднъж, включително 16 периодични квоти с публикуван положителен месечен бюджет от токени плюс пет лимита на Groq за отделни модели; 13 доставчици са отбелязани за избягване в каталога на рисковете, свързани с условията, така че вие решавате. Лентата на бюджета включва Mistral 1 млрд., Nara 210 млн., LLM7 150 млн., Groq 30 млн. (пет лимита за отделни модели) и по-малки квоти, а кредитите при регистрация за първия месец и постоянно безплатните доставчици без лимит на токените са показани отделно, така че никога да не завишават общата стойност. Текущо използвани/оставащи в /dashboard/free-tiers."/>

> Анимирано обобщение на активната страница `/dashboard/free-tiers`. Пълна методология (премахване на дублирането по квоти, нива на кредитите, условия на доставчиците): **[docs/reference/FREE_TIERS.md](docs/reference/FREE_TIERS.md)**.
>
> <sub>Тези стойности се проверяват отново на всеки две седмици спрямо актуалния каталог и **се променят и в двете посоки** — ако доставчик прекрати безплатен план, стойността спада; ако се появи нов, тя нараства. Публикуваме това, което каталогът действително изчислява, а не закръглен нагоре най-добър сценарий.</sub>
...
⭐ Добавете звезда на хранилището, ако OMNIROUTE ви е помогнал да спестите пари и да улесните работата си.
...
[![Класация по история на звездите](https://api.star-history.com/badge?repo=diegosouzapw/OmniRoute&theme=dark)](https://www.star-history.com/diegosouzapw/omniroute)
[![olud.ai](https://olud.ai/badge.php?tool=diegosouzapw-omniroute)](https://olud.ai/project/diegosouzapw-omniroute.html)

### 💬 Присъединете се към общността

**👋 Последвайте поддържащия проекта — научавайте първи за нови доставчици, издания и съвети:**
...
## 📈 Gateway продължава да расте

<div align="center">

|                              | v3.8.49 |        **v3.8.50**        | `v3.8.51+` |
| ---------------------------- | :-----: | :-----------------------: | :--------: |
| 🌐 Доставчици                |   290   |          **352**          | още чакат  |
...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="#-352-ai-providers--154-catalog-marked-free">🌐 Доставчици</a></td>
    <td align="center"><a href="#-full-cli--a2a--mcp">🔌 CLI и MCP</a></td>
  </tr>
  <tr>
    <td align="right"></td>
    <td align="center"><a href="#%EF%B8%8F-save-1595-tokens--automatically">🗜️ Компресия</a></td>
  ...
  <tr>
    ...
    <td align="center"><a href="#-support-omniroute">💚 Подкрепа / Дарение</a></td>
...
## 🆓 Работи веднага след инсталирането — без ключове, без конфигурация

</div>

<img src="./docs/diagrams/works-zero-config.svg" width="100%" alt="Работи веднага след инсталирането — без конфигурация. Три стъпки: 1. Инсталирайте — npm i -g omniroute, сървърът се стартира на localhost:20128. 2. Насочете инструмента си към http://localhost:20128/v1 — всеки инструмент, съвместим с OpenAI (Claude Code, Cursor, Cline). 3. Получавате отговор — извикайте модела auto за незабавен отговор, без API ключ, регистрация или конфигурация. Доставчикът без ключ OpenCode Free е предварително включен в комбинацията auto, така че чисто нова инсталация работи веднага."/>

```bash
# Чиста инсталация, без идентификационни данни — `auto` вече работи:
curl http://localhost:20128/v1/chat/completions \
  -H "Content-Type: application/json" \
  -d '{"model":"auto","messages":[{"role":"user","content":"Hello!"}]}'
```

<sub>Предпочитате конкретна безплатна услуга? Извикайте директно `oc/…` (OpenCode Free). След това преминете към `auto` и оставете OmniRoute да избира.</sub>
...
<img src="./docs/diagrams/promise-pillars.svg" width="100%" alt="Обещанието — една крайна точка и 359 доставчика. Автоматичното резервно превключване поддържа маршрутизирането, докато е налична друга работеща цел. Шест стълба: устойчиво резервно превключване между 359 доставчика · до 95% спестяване на токени при подходящи натоварвания · старт за $0 със 150+ безплатни нива и 53 периодични/безключови доставчика, безплатни завинаги · 36 интеграции с CLI/агенти чрез една конфигурация · съвместимост с OpenAI, Claude, Gemini и Responses API на /v1 · контроли за продукционна среда, включително прекъсвачи на вериги, TLS прикриване, MCP със 110 инструмента, A2A, памет, защитни механизми, оценки и 39 000+ декларации за статични тестове в 5 100+ проследявани тестови файла."/>
...
<img src="./docs/diagrams/why-pain-fix.svg" width="100%" alt="Защо OmniRoute — спрете да жонглирате с 10 табла за управление, невалидни API ключове и неочаквани сметки. Десет ежедневни проблема и решенията им: неизползвана квота с изтичащ срок → максимално използване на абонаментите; ограничения на заявките по време на програмиране → 4-степенно автоматично резервно превключване (Абонамент → API → Евтини → Безплатни); резултатите от инструментите изразходват токени → компресиране с RTK + Caveman (15–95%); скъпи API → маршрутизиране, оптимизирано по цена; всеки инструмент изисква собствена настройка → една крайна точка, едно табло за управление; блокиран ИИ → 3-степенно прокси + TLS прикриване; невалидни ключове → 3-слойна устойчивост (прекъсвачи на вериги, период на изчакване за ключове, блокиране на модели); екипът споделя един абонамент → пулове от ключове с квоти за справедливо разпределение; подканите преминават през нечий облак → локален подход с ключове, криптирани чрез AES-256-GCM; липса на видимост върху разходите → анализи в реално време (използване, квота, спестявания, p95 латентност)."/>

<div align="center">

<img src="./docs/diagrams/tier-cascade.svg" width="100%" alt="Поток на заявките в OmniRoute: вашата IDE или CLI (Claude Code, Cursor, Cline…) извиква една локална крайна точка (http://localhost:20128/v1); интелигентният маршрутизатор на OmniRoute (компресиране с RTK + Caveman, 19 стратегии за маршрутизиране, прекъсвачи на вериги, TLS прикриване, MCP, A2A, защитни механизми) може да превключва между 4 нива на доставчици, докато остава подходяща и работеща цел — Ниво 1 Абонамент, Ниво 2 API ключ, Ниво 3 Евтини и Ниво 4 Безплатни."/>
...
Основното послание за безплатното ниво остава **~1,47 млрд. токена/месец** от документирания,
дедуплициран между пуловете каталог по-горе. Временните кредити при регистрация при доставчици могат отделно да увеличат капацитета за първия
месец до **~2,07 млрд.** Radar е незадължителен, подписан слой върху каталога за потребители, които искат по-актуална
информация за наличността на безплатни модели между версиите на OmniRoute; каталогът на общността и всички съществуващи безплатни
функции остават безплатни.

Поддръжниците могат да получават каталога в реално време и допълнителни възможности от доставчици. Неговият отделен,
променлив лимит е **най-много приблизително 3 млрд. токена/месец** в зависимост от наличността при доставчиците.
Този лимит не е гарантиран: доставчиците могат по всяко време да променят квотите, критериите за допустимост, моделите или регионите.

Radar се активира по желание и използва само GET. Клиентът OmniRoute не качва подкани, трафик, конфигурация на
доставчици, телеметрия за използването или локалното състояние за скриване на съобщения. Научете повече за критериите за допустимост и
...
## 🌐 352 доставчици на AI — 152 отбелязани в каталога като безплатни

</div>

> **352 регистрирани доставчици** в каноничните колекции за чат, медии, търсене, локални услуги, облачни агенти и системни услуги, включително **152 с метаданни за откриване `hasFree: true`**. Регистърът с чат модели обхваща **229 доставчици / 2 554 уникални двойки доставчик-модел / 1 283 необработени идентификатора на модели**; отделният каталог с безплатни квоти съдържа **443 реда за отделни модели**, **34 периодично подновяващи се пула** и **53 периодично подновяващи се/неизискващи ключ доставчици с безплатен достъп завинаги**. Това са различни знаменатели по замисъл; определенията и изчисленията с премахнато дублиране на пуловете се намират в [Справочника за доставчиците](docs/reference/PROVIDER_REFERENCE.md) и [Безплатните планове](docs/reference/FREE_TIERS.md).
...
<table>
  <tr>
    <td align="center" width="150"><img src="./public/providers/cli-generic.svg" width="42" alt="OpenCode Zen"/><br/><b>OpenCode Zen</b><br/><sub>DeepSeek V4, Nemotron 3<br/>Без лимит на токените</sub></td>
    ...
    <td align="center" width="150"><img src="https://cdn.jsdelivr.net/npm/@lobehub/icons-static-svg@1.91.0/icons/siliconcloud-color.svg" width="42" alt="SiliconFlow"/><br/><b>SiliconFlow</b><br/><sub>DeepSeek V3.2 / R1<br/>Безплатно ниво</sub></td>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/USER_GUIDE.md">Ръководство за потребителя</a></b></td><td>Доставчици, комбинации, CLI интеграция, внедряване</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/reference/CLI-TOOLS.md">Ръководство за CLI инструменти</a></b></td><td>Настройка на отделните инструменти за Claude Code, Codex, Cursor, Cline, OpenClaw, Kilo, Copilot</td></tr>
  <tr><td nowrap><b><a href="docs/guides/REMOTE-MODE.md">Отдалечен режим</a></b></td><td>Управлявайте отдалечен OmniRoute (VPS) чрез CLI на лаптопа си с помощта на токени за достъп с ограничен обхват</td></tr>
  <tr><td nowrap><b><a href="docs/guides/CLAUDE-CODE-CONFIGURATION.md">Конфигурация на Claude Code</a></b></td><td>Насочете Claude Code към OmniRoute (локален/отдалечен) с <code>launch</code> и профили за отделните модели</td></tr>
  <tr><td nowrap><b><a href="README.md#-quick-start">Бърз старт</a></b></td><td>Инсталиране в 3 стъпки → свързване → конфигуриране</td></tr>
</table>

### 🔧 Операции и внедряване

<table>
  <tr><th align="left">Документ</th><th align="left">Описание</th></tr>
  <tr><td nowrap><b><a href="docs/guides/DOCKER_GUIDE.md">Ръководство за Docker</a></b></td><td>Docker run, Compose профили, Caddy HTTPS, тунели, тагове на образи</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/ops/VM_DEPLOYMENT_GUIDE.md">Внедряване във виртуална машина</a></b></td><td>Пълно ръководство: настройка на виртуална машина + nginx + Cloudflare</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/guides/TERMUX_GUIDE.md">Ръководство за Termux</a></b></td><td>Стартиране на OmniRoute под Android чрез Termux</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/guides/UNINSTALL.md">Ръководство за деинсталиране</a></b></td><td>Чисто премахване при всички методи за инсталиране</td></tr>
  <tr><td nowrap><b><a href="docs/reference/ENVIRONMENT.md">Конфигурация на средата</a></b></td><td>Всички променливи и справочна информация за <code>.env</code></td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/compression/COMPRESSION_GUIDE.md">Ръководство за компресиране</a></b></td><td>Конвейер със 7 опции: изключено / олекотено / стандартно / агресивно / ултра / RTK / комбинирано</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/compression/COMPRESSION_RULES_FORMAT.md">Формат на правилата за компресиране</a></b></td><td>JSON схеми за пакети от правила за филтрите на Caveman и RTK</td></tr>
  <tr><td nowrap><b><a href="docs/compression/COMPRESSION_LANGUAGE_PACKS.md">Езикови пакети за компресиране</a></b></td><td>Разпознаване на езика и създаване на пакети от правила за Caveman</td></tr>
  <tr><td nowrap><b><a href="docs/architecture/RESILIENCE_GUIDE.md">Ръководство за устойчивост</a></b></td><td>Прекъсвачи на вериги, периоди за изчакване, опашка, защита от лавинообразни заявки, TLS спуфинг</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/ops/PROXY_GUIDE.md">Ръководство за прокси</a></b></td><td>Тристепенна прокси система, пазар на 1proxy, CRUD операции с регистъра</td></tr>
  <tr><td nowrap><b><a href="docs/reference/FREE_TIERS.md">Безплатни нива</a></b></td><td>Обединен каталог: 34 документирани периодично подновявани пула / 452 каталогизирани записа за безплатни нива</td></tr>
  <tr><td nowrap><b><a href="docs/guides/FEATURES.md">Галерия с функционалности</a></b></td><td>Визуална обиколка на таблото с екранни снимки</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/openapi.yaml">Спецификация на OpenAPI</a></b></td><td>Спецификация OpenAPI 3.0</td></tr>
  <tr><td nowrap><b><a href="open-sse/mcp-server/README.md">MCP сървър</a></b></td><td>110 MCP инструмента, IDE конфигурации, клиенти за Python/TS/Go</td></tr>
  <tr><td nowrap><b><a href="docs/frameworks/MCP-SERVER.md">Ръководство за MCP сървъра</a></b></td><td>Инсталиране на MCP, преносни механизми и справочник за инструментите</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/ops/BRANCHING_MODEL.md">Модел за разклоняване и издания</a></b></td><td>Към кои клонове са насочени PR заявките (<code>release/*</code>) и какво означават <code>main</code> и таговете</td></tr>
  <tr><td nowrap><b><a href="CHANGELOG.md">Регистър на промените</a></b></td><td>Пълна история на изданията за всяка версия</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/ops/COVERAGE_PLAN.md">План за покритие</a></b></td><td>Стратегия за тестово покритие на над 39 000 статични декларации на тестове в над 5 100 проследявани тестови файла</td></tr>
</table>
...
<table>
  <tr><th align="center">Място</th><th align="left">Участник</th><th align="center">Слети PR заявки</th><th align="right">~Променени редове</th></tr>
...
<sub>Данните са фиксирани към последния към момента комит <code>dafb4ae808</code> на <code>release/v3.8.50</code>, включително сливанията до 2026-08-24 05:26:03 UTC. Страницираното преброяване чрез GitHub GraphQL съдържа 5 911 слети PR заявки: 2 707 от собственика на хранилището, 179 от Dependabot и <b>3 025 външни PR заявки от 535 отделни участници</b>. „Променени редове“ представлява сбора от добавените и изтритите редове според GitHub и включва генерирани файлове, заключващи файлове, каталози, преводи и документация; това е обемът на промените, а не броят авторски редове код. Равните резултати на границата са запазени.</sub>
...
<table>
  <tr>
    ...
    <td align="center" width="160">
      ...
      <sub>🏅 69 приписани от GitHub комита · споделено 6-о място</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="160">
    ...
    <td align="center" width="160">
      ...
      <sub>🏅 51 приписани от GitHub комита · споделено 10-о място</sub>
    </td>
    <td align="center" width="160">
...
<sub>Повторно проверено на 2026-08-24 06:14:31 UTC: приписани от GitHub комити, отчетени от Contributors API на хранилището за клона по подразбиране <code>release/v3.8.50</code>. API върна 525 самоличности (415 потребители, 2 бота, 108 анонимни); тази таблица изключва поддържащия проекта, ботовете и анонимните самоличности и запазва споделените места в класирането. Тя се различава както от класацията по слети PR по-горе, така и от преброяването на 639 души въз основа на Git метаданни по-долу.</sub>

> 🙏 Функционалностите, корекциите на грешки и подобренията на инфраструктурата от тези сътрудници са **основна част** от това, което прави OmniRoute надежден и богат на функционалности. Всяка заявка за сливане, всеки тестов случай и всеки файл за i18n превод имат значение. Отвореният код се изгражда от хора като тях.
