...
🌐 **زبانیں:** 🇺🇸 [انگریزی](./ARCHITECTURE.md) | 🇪🇹 [امہاری](../i18n/am/docs/architecture/ARCHITECTURE.md) | 🇸🇦 [عربی](../i18n/ar/docs/architecture/ARCHITECTURE.md) | 🇦🇿 [آذربائیجانی](../i18n/az/docs/architecture/ARCHITECTURE.md) | 🇧🇬 [بلغاری](../i18n/bg/docs/architecture/ARCHITECTURE.md) | 🇧🇩 [بنگالی](../i18n/bn/docs/architecture/ARCHITECTURE.md) | 🇨🇿 [چیک](../i18n/cs/docs/architecture/ARCHITECTURE.md) | 🇩🇰 [ڈینش](../i18n/da/docs/architecture/ARCHITECTURE.md) | 🇩🇪 [جرمن](../i18n/de/docs/architecture/ARCHITECTURE.md) | 🇬🇷 [یونانی](../i18n/el/docs/architecture/ARCHITECTURE.md) | 🇪🇸 [ہسپانوی](../i18n/es/docs/architecture/ARCHITECTURE.md) | 🇪🇪 [اسٹونین](../i18n/et/docs/architecture/ARCHITECTURE.md) | 🇮🇷 [فارسی](../i18n/fa/docs/architecture/ARCHITECTURE.md) | 🇫🇮 [فنش](../i18n/fi/docs/architecture/ARCHITECTURE.md) | 🇫🇷 [فرانسیسی](../i18n/fr/docs/architecture/ARCHITECTURE.md) | 🇮🇪 [آئرش](../i18n/ga/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [گجراتی](../i18n/gu/docs/architecture/ARCHITECTURE.md) | 🇳🇬 [ہاؤسا](../i18n/ha/docs/architecture/ARCHITECTURE.md) | 🇮🇱 [عبرانی](../i18n/he/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [ہندی](../i18n/hi/docs/architecture/ARCHITECTURE.md) | 🇭🇷 [کروشین](../i18n/hr/docs/architecture/ARCHITECTURE.md) | 🇭🇺 [ہنگری](../i18n/hu/docs/architecture/ARCHITECTURE.md) | 🇦🇲 [آرمینیائی](../i18n/hy/docs/architecture/ARCHITECTURE.md) | 🇮🇩 [انڈونیشیائی](../i18n/id/docs/architecture/ARCHITECTURE.md) | 🇳🇬 [اِگبو](../i18n/ig/docs/architecture/ARCHITECTURE.md) | 🇮🇹 [اطالوی](../i18n/it/docs/architecture/ARCHITECTURE.md) | 🇯🇵 [جاپانی](../i18n/ja/docs/architecture/ARCHITECTURE.md) | 🇬🇪 [جارجیائی](../i18n/ka/docs/architecture/ARCHITECTURE.md) | 🇰🇭 [خمیر](../i18n/km/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [کنڑ](../i18n/kn/docs/architecture/ARCHITECTURE.md) | 🇰🇷 [کوریائی](../i18n/ko/docs/architecture/ARCHITECTURE.md) | 🇱🇹 [لتھوانیائی](../i18n/lt/docs/architecture/ARCHITECTURE.md) | 🇱🇻 [لیٹوین](../i18n/lv/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [ملیالم](../i18n/ml/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [مراٹھی](../i18n/mr/docs/architecture/ARCHITECTURE.md) | 🇲🇾 [مالے](../i18n/ms/docs/architecture/ARCHITECTURE.md) | 🇲🇹 [مالٹی](../i18n/mt/docs/architecture/ARCHITECTURE.md) | 🇲🇲 [برمی](../i18n/my/docs/architecture/ARCHITECTURE.md) | 🇳🇵 [نیپالی](../i18n/ne/docs/architecture/ARCHITECTURE.md) | 🇳🇱 [ڈچ](../i18n/nl/docs/architecture/ARCHITECTURE.md) | 🇳🇴 [نارویجین](../i18n/no/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [اوڈیا](../i18n/or/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [پنجابی](../i18n/pa/docs/architecture/ARCHITECTURE.md) | 🇵🇭 [فلپائنی](../i18n/phi/docs/architecture/ARCHITECTURE.md) | 🇵🇱 [پولش](../i18n/pl/docs/architecture/ARCHITECTURE.md) | 🇵🇹 [پرتگالی (پرتگال)](../i18n/pt/docs/architecture/ARCHITECTURE.md) | 🇧🇷 [پرتگالی (برازیل)](../i18n/pt-BR/docs/architecture/ARCHITECTURE.md) | 🇷🇴 [رومانیائی](../i18n/ro/docs/architecture/ARCHITECTURE.md) | 🇷🇺 [روسی](../i18n/ru/docs/architecture/ARCHITECTURE.md) | 🇱🇰 [سنہالی](../i18n/si/docs/architecture/ARCHITECTURE.md) | 🇸🇰 [سلوواک](../i18n/sk/docs/architecture/ARCHITECTURE.md) | 🇸🇮 [سلووینیائی](../i18n/sl/docs/architecture/ARCHITECTURE.md) | 🇷🇸 [سربیائی](../i18n/sr/docs/architecture/ARCHITECTURE.md) | 🇸🇪 [سویڈش](../i18n/sv/docs/architecture/ARCHITECTURE.md) | 🇰🇪 [سواحلی](../i18n/sw/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [تمل](../i18n/ta/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [تیلگو](../i18n/te/docs/architecture/ARCHITECTURE.md) | 🇹🇭 [تھائی](../i18n/th/docs/architecture/ARCHITECTURE.md) | 🇹🇷 [ترکی](../i18n/tr/docs/architecture/ARCHITECTURE.md) | 🇺🇦 [یوکرینی](../i18n/uk-UA/docs/architecture/ARCHITECTURE.md) | 🇵🇰 [اردو](../i18n/ur/docs/architecture/ARCHITECTURE.md) | 🇺🇿 [ازبک](../i18n/uz/docs/architecture/ARCHITECTURE.md) | 🇻🇳 [ویتنامی](../i18n/vi/docs/architecture/ARCHITECTURE.md) | 🇳🇬 [یوروبا](../i18n/yo/docs/architecture/ARCHITECTURE.md) | 🇨🇳 [چینی (آسان)](../i18n/zh-CN/docs/architecture/ARCHITECTURE.md) | 🇹🇼 [چینی (روایتی)](../i18n/zh-TW/docs/architecture/ARCHITECTURE.md)
...
sequenceDiagram
    autonumber
    participant Client as CLI/SDK کلائنٹ
    participant Route as /api/v1/chat/completions
    participant Chat as src/sse/handlers/chat
    participant Core as open-sse/handlers/chatCore
    participant Model as ماڈل ریزالور
    participant Auth as اسناد کا انتخاب کنندہ
    participant Exec as پرووائیڈر ایگزیکیوٹر
    participant Prov as اپ اسٹریم پرووائیڈر
    participant Stream as اسٹریم مترجم
    participant Usage as usageDb

    Client->>Route: POST /v1/chat/completions
    Route->>Chat: handleChat(request)
    Chat->>Model: ماڈل یا combo کو پارس/resolve کریں

    alt Combo ماڈل
        Chat->>Chat: combo ماڈلز پر iterate کریں (handleComboChat)
    end

    Chat->>Auth: getProviderCredentials(provider)
    Auth-->>Chat: فعال اکاؤنٹ + tokens/api key

    Chat->>Core: handleChatCore(body, modelInfo, credentials)
    Core->>Core: ماخذ format کا پتہ لگائیں
    Core->>Core: درخواست کو ہدف format میں ترجمہ کریں
    Core->>Exec: execute(provider, transformedBody)
    Exec->>Prov: اپ اسٹریم API call
    Prov-->>Exec: SSE/JSON جواب
    Exec-->>Core: جواب + metadata

    alt 401/403
        Core->>Exec: refreshCredentials()
        Exec-->>Core: اپ ڈیٹ کردہ tokens
        Core->>Exec: درخواست دوبارہ آزمائیں
    end

    Core->>Stream: اسٹریم کو کلائنٹ format میں ترجمہ/normalize کریں
    Stream-->>Client: SSE chunks / JSON جواب

    Stream->>Usage: استعمال نکالیں + history/log محفوظ کریں
```
...
```mermaid
flowchart TD
    A[آنے والی ماڈل اسٹرنگ] --> B{کیا یہ کومبو کا نام ہے؟}
    B -- ہاں --> C[کومبو ماڈلز کی ترتیب لوڈ کریں]
    B -- نہیں --> D[واحد ماڈل کا راستہ]

    C --> E[ماڈل N آزمائیں]
    E --> F[پرووائیڈر/ماڈل متعین کریں]
    D --> F

    F --> G[اکاؤنٹ کی اسناد منتخب کریں]
    G --> H{کیا اسناد دستیاب ہیں؟}
    H -- نہیں --> I[پرووائیڈر کی عدم دستیابی لوٹائیں]
    H -- ہاں --> J[درخواست چلائیں]

    J --> K{کامیاب؟}
    K -- ہاں --> L[جواب لوٹائیں]
    K -- نہیں --> M{کیا خرابی فال بیک کے لیے اہل ہے؟}

    M -- نہیں --> N[خرابی لوٹائیں]
    M -- ہاں --> O[اکاؤنٹ کو کول ڈاؤن کے لیے غیر دستیاب نشان زد کریں]
    O --> P{کیا پرووائیڈر کے لیے کوئی اور اکاؤنٹ ہے؟}
    P -- ہاں --> G
    P -- نہیں --> Q{کیا کومبو میں اگلا ماڈل موجود ہے؟}
    Q -- ہاں --> E
    Q -- نہیں --> R[سب کے غیر دستیاب ہونے کی اطلاع لوٹائیں]
```
...
sequenceDiagram
    autonumber
    participant UI as ڈیش بورڈ UI
    participant OAuth as /api/oauth/[provider]/[action]
    participant ProvAuth as پرووائیڈر تصدیقی سرور
    participant DB as localDb
    participant Test as /api/providers/[id]/test
    participant Exec as پرووائیڈر ایگزیکیوٹر

    UI->>OAuth: GET کے ذریعے اجازت یا ڈیوائس کوڈ
    OAuth->>ProvAuth: تصدیق/ڈیوائس فلو بنائیں
    ProvAuth-->>OAuth: تصدیقی URL یا ڈیوائس کوڈ پے لوڈ
    OAuth-->>UI: فلو ڈیٹا

    UI->>OAuth: POST کے ذریعے تبادلہ یا پول
    OAuth->>ProvAuth: ٹوکن کا تبادلہ/پول
    ProvAuth-->>OAuth: رسائی/ریفریش ٹوکنز
    OAuth->>DB: createProviderConnection(oauth data)
    OAuth-->>UI: کامیابی + کنکشن id

    UI->>Test: POST /api/providers/[id]/test
    Test->>Exec: اسناد کی توثیق / اختیاری ریفریش
    Exec-->>Test: درست یا ریفریش شدہ ٹوکن کی معلومات
    Test->>DB: اسٹیٹس/ٹوکنز/خرابیاں اپ ڈیٹ کریں
    Test-->>UI: توثیق کا نتیجہ
```
...
sequenceDiagram
    autonumber
    participant UI as اینڈ پوائنٹ صفحہ UI
    participant Sync as /api/sync/cloud
    participant DB as localDb
    participant Cloud as بیرونی کلاؤڈ سنک
    participant Claude as ~/.claude/settings.json

    UI->>Sync: POST action=enable
    Sync->>DB: cloudEnabled=true سیٹ کریں
    Sync->>DB: یقینی بنائیں کہ API کلید موجود ہے
    Sync->>Cloud: POST /sync/{machineId} (providers/aliases/combos/keys)
    Cloud-->>Sync: سنک کا نتیجہ
    Sync->>Cloud: GET /{machineId}/v1/verify
    Sync-->>UI: فعال + توثیقی اسٹیٹس

    UI->>Sync: POST action=sync
    Sync->>Cloud: POST /sync/{machineId}
    Cloud-->>Sync: ریموٹ ڈیٹا
    Sync->>DB: زیادہ نئے مقامی ٹوکنز/اسٹیٹس اپ ڈیٹ کریں
    Sync-->>UI: سنک مکمل

    UI->>Sync: POST action=disable
    Sync->>DB: cloudEnabled=false سیٹ کریں
    Sync->>Cloud: DELETE /sync/{machineId}
    Sync->>Claude: ANTHROPIC_BASE_URL کو دوبارہ مقامی پر منتقل کریں (اگر ضروری ہو)
    Sync-->>UI: غیر فعال
```
...
```mermaid
erDiagram
    SETTINGS ||--o{ PROVIDER_CONNECTION : کنٹرول_کرتا_ہے
    PROVIDER_NODE ||--o{ PROVIDER_CONNECTION : ہم_آہنگ_فراہم_کنندہ_کو_سہارا_دیتا_ہے
    PROVIDER_CONNECTION ||--o{ USAGE_ENTRY : استعمال_جاری_کرتا_ہے
...
```mermaid
flowchart LR
    subgraph LocalHost[ڈیولپر ہوسٹ]
        CLI[CLI ٹولز]
        Browser[ڈیش بورڈ براؤزر]
    end

    subgraph ContainerOrProcess[OmniRoute رن ٹائم]
        Next[Next.js سرور\nPORT=20128]
        Core[SSE کور + ایگزیکیوٹرز]
        MainDB[(storage.sqlite)]
        UsageDB[(استعمال کی ٹیبلز + لاگ آرٹیفیکٹس)]
    end

    subgraph External[بیرونی سروسز]
        Providers[AI فراہم کنندگان]
        SyncCloud[کلاؤڈ سنک سروس]
    end
