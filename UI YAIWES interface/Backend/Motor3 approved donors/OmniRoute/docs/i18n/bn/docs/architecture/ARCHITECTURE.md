...
🌐 **ভাষাসমূহ:** 🇺🇸 [ইংরেজি](./ARCHITECTURE.md) | 🇪🇹 [আমহারিক](../i18n/am/docs/architecture/ARCHITECTURE.md) | 🇸🇦 [আরবি](../i18n/ar/docs/architecture/ARCHITECTURE.md) | 🇦🇿 [আজারবাইজানি](../i18n/az/docs/architecture/ARCHITECTURE.md) | 🇧🇬 [বুলগেরীয়](../i18n/bg/docs/architecture/ARCHITECTURE.md) | 🇧🇩 [বাংলা](../i18n/bn/docs/architecture/ARCHITECTURE.md) | 🇨🇿 [চেক](../i18n/cs/docs/architecture/ARCHITECTURE.md) | 🇩🇰 [ড্যানিশ](../i18n/da/docs/architecture/ARCHITECTURE.md) | 🇩🇪 [জার্মান](../i18n/de/docs/architecture/ARCHITECTURE.md) | 🇬🇷 [গ্রিক](../i18n/el/docs/architecture/ARCHITECTURE.md) | 🇪🇸 [স্প্যানিশ](../i18n/es/docs/architecture/ARCHITECTURE.md) | 🇪🇪 [এস্তোনীয়](../i18n/et/docs/architecture/ARCHITECTURE.md) | 🇮🇷 [ফারসি](../i18n/fa/docs/architecture/ARCHITECTURE.md) | 🇫🇮 [ফিনিশ](../i18n/fi/docs/architecture/ARCHITECTURE.md) | 🇫🇷 [ফরাসি](../i18n/fr/docs/architecture/ARCHITECTURE.md) | 🇮🇪 [আইরিশ](../i18n/ga/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [গুজরাটি](../i18n/gu/docs/architecture/ARCHITECTURE.md) | 🇳🇬 [হাউসা](../i18n/ha/docs/architecture/ARCHITECTURE.md) | 🇮🇱 [হিব্রু](../i18n/he/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [হিন্দি](../i18n/hi/docs/architecture/ARCHITECTURE.md) | 🇭🇷 [ক্রোয়েশীয়](../i18n/hr/docs/architecture/ARCHITECTURE.md) | 🇭🇺 [হাঙ্গেরীয়](../i18n/hu/docs/architecture/ARCHITECTURE.md) | 🇦🇲 [আর্মেনীয়](../i18n/hy/docs/architecture/ARCHITECTURE.md) | 🇮🇩 [ইন্দোনেশীয়](../i18n/id/docs/architecture/ARCHITECTURE.md) | 🇳🇬 [ইগবো](../i18n/ig/docs/architecture/ARCHITECTURE.md) | 🇮🇹 [ইতালীয়](../i18n/it/docs/architecture/ARCHITECTURE.md) | 🇯🇵 [জাপানি](../i18n/ja/docs/architecture/ARCHITECTURE.md) | 🇬🇪 [জর্জীয়](../i18n/ka/docs/architecture/ARCHITECTURE.md) | 🇰🇭 [খমের](../i18n/km/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [কন্নড়](../i18n/kn/docs/architecture/ARCHITECTURE.md) | 🇰🇷 [কোরীয়](../i18n/ko/docs/architecture/ARCHITECTURE.md) | 🇱🇹 [লিথুয়ানীয়](../i18n/lt/docs/architecture/ARCHITECTURE.md) | 🇱🇻 [লাতভীয়](../i18n/lv/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [মালয়ালম](../i18n/ml/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [মারাঠি](../i18n/mr/docs/architecture/ARCHITECTURE.md) | 🇲🇾 [মালয়](../i18n/ms/docs/architecture/ARCHITECTURE.md) | 🇲🇹 [মাল্টীয়](../i18n/mt/docs/architecture/ARCHITECTURE.md) | 🇲🇲 [বার্মিজ](../i18n/my/docs/architecture/ARCHITECTURE.md) | 🇳🇵 [নেপালি](../i18n/ne/docs/architecture/ARCHITECTURE.md) | 🇳🇱 [ওলন্দাজ](../i18n/nl/docs/architecture/ARCHITECTURE.md) | 🇳🇴 [নরওয়েজীয়](../i18n/no/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [ওড়িয়া](../i18n/or/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [পাঞ্জাবি](../i18n/pa/docs/architecture/ARCHITECTURE.md) | 🇵🇭 [ফিলিপিনো](../i18n/phi/docs/architecture/ARCHITECTURE.md) | 🇵🇱 [পোলিশ](../i18n/pl/docs/architecture/ARCHITECTURE.md) | 🇵🇹 [পর্তুগিজ (পর্তুগাল)](../i18n/pt/docs/architecture/ARCHITECTURE.md) | 🇧🇷 [পর্তুগিজ (ব্রাজিল)](../i18n/pt-BR/docs/architecture/ARCHITECTURE.md) | 🇷🇴 [রোমানীয়](../i18n/ro/docs/architecture/ARCHITECTURE.md) | 🇷🇺 [রুশ](../i18n/ru/docs/architecture/ARCHITECTURE.md) | 🇱🇰 [সিংহলি](../i18n/si/docs/architecture/ARCHITECTURE.md) | 🇸🇰 [স্লোভাক](../i18n/sk/docs/architecture/ARCHITECTURE.md) | 🇸🇮 [স্লোভেনীয়](../i18n/sl/docs/architecture/ARCHITECTURE.md) | 🇷🇸 [সার্বীয়](../i18n/sr/docs/architecture/ARCHITECTURE.md) | 🇸🇪 [সুইডিশ](../i18n/sv/docs/architecture/ARCHITECTURE.md) | 🇰🇪 [সোয়াহিলি](../i18n/sw/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [তামিল](../i18n/ta/docs/architecture/ARCHITECTURE.md) | 🇮🇳 [তেলুগু](../i18n/te/docs/architecture/ARCHITECTURE.md) | 🇹🇭 [থাই](../i18n/th/docs/architecture/ARCHITECTURE.md) | 🇹🇷 [তুর্কি](../i18n/tr/docs/architecture/ARCHITECTURE.md) | 🇺🇦 [ইউক্রেনীয়](../i18n/uk-UA/docs/architecture/ARCHITECTURE.md) | 🇵🇰 [উর্দু](../i18n/ur/docs/architecture/ARCHITECTURE.md) | 🇺🇿 [উজবেক](../i18n/uz/docs/architecture/ARCHITECTURE.md) | 🇻🇳 [ভিয়েতনামি](../i18n/vi/docs/architecture/ARCHITECTURE.md) | 🇳🇬 [ইয়োরুবা](../i18n/yo/docs/architecture/ARCHITECTURE.md) | 🇨🇳 [চীনা (সরলীকৃত)](../i18n/zh-CN/docs/architecture/ARCHITECTURE.md) | 🇹🇼 [চীনা (ঐতিহ্যবাহী)](../i18n/zh-TW/docs/architecture/ARCHITECTURE.md)
...
![রিকোয়েস্ট পাইপলাইন (/v1/chat/completions)](../diagrams/exported/request-pipeline.svg)

> সোর্স: [diagrams/request-pipeline.mmd](../diagrams/request-pipeline.mmd)

![৩-স্তরবিশিষ্ট সহনশীলতা মডেল](../diagrams/exported/resilience-3layers.svg)
...
```mermaid
flowchart LR
    subgraph Clients[ডেভেলপার ক্লায়েন্টসমূহ]
        C1[Claude Code]
        C2[Codex CLI]
        C3[OpenClaw / Droid / Cline / Continue / Roo]
        C4[কাস্টম OpenAI-সামঞ্জস্যপূর্ণ ক্লায়েন্ট]
        BROWSER[ব্রাউজার ড্যাশবোর্ড]
    end

    subgraph Router[OmniRoute লোকাল প্রসেস]
        API[V1 সামঞ্জস্য API\n/v1/*]
        DASH[ড্যাশবোর্ড + ব্যবস্থাপনা API\n/api/*]
        CORE[SSE + অনুবাদ কোর\nopen-sse + src/sse]
        DB[(storage.sqlite)]
        UDB[(ব্যবহার-সংক্রান্ত টেবিল + লগ আর্টিফ্যাক্ট)]
    end

    subgraph Upstreams[আপস্ট্রিম প্রোভাইডারসমূহ]
        P1[OAuth প্রোভাইডার\nClaude/Codex/Gemini/Qoder/GitHub/Kiro/Cursor/Antigravity]
        P2[API কী প্রোভাইডার\nOpenAI/Anthropic/OpenRouter/GLM/Kimi/MiniMax\nDeepSeek/Groq/xAI/Mistral/Perplexity\nTogether/Fireworks/Cerebras/Cohere/NVIDIA]
        P3[সামঞ্জস্যপূর্ণ নোড\nOpenAI-সামঞ্জস্যপূর্ণ / Anthropic-সামঞ্জস্যপূর্ণ]
    end

    subgraph Cloud[ঐচ্ছিক ক্লাউড সিঙ্ক]
        CLOUD[ক্লাউড সিঙ্ক এন্ডপয়েন্ট\nNEXT_PUBLIC_CLOUD_URL]
    end
...
```mermaid
flowchart TD
    A[ইনকামিং মডেল স্ট্রিং] --> B{কম্বোর নাম?}
    B -- হ্যাঁ --> C[কম্বো মডেলের ক্রম লোড করুন]
    B -- না --> D[একক মডেলের পথ]

    C --> E[মডেল N চেষ্টা করুন]
    E --> F[প্রোভাইডার/মডেল নির্ধারণ করুন]
    D --> F

    F --> G[অ্যাকাউন্টের ক্রেডেনশিয়াল নির্বাচন করুন]
    G --> H{ক্রেডেনশিয়াল উপলভ্য?}
    H -- না --> I[প্রোভাইডার অনুপলভ্য ফেরত দিন]
    H -- হ্যাঁ --> J[রিকোয়েস্ট সম্পাদন করুন]

    J --> K{সফল?}
    K -- হ্যাঁ --> L[রেসপন্স ফেরত দিন]
    K -- না --> M{ফলব্যাক-যোগ্য ত্রুটি?}

    M -- না --> N[ত্রুটি ফেরত দিন]
    M -- হ্যাঁ --> O[অ্যাকাউন্টকে কুলডাউন সময়ের জন্য অনুপলভ্য হিসেবে চিহ্নিত করুন]
    O --> P{প্রোভাইডারের জন্য অন্য অ্যাকাউন্ট আছে?}
    P -- হ্যাঁ --> G
    P -- না --> Q{কম্বোতে পরবর্তী মডেল আছে?}
    Q -- হ্যাঁ --> E
    Q -- না --> R[সব অনুপলভ্য ফেরত দিন]
```
...
sequenceDiagram
    autonumber
    participant UI as ড্যাশবোর্ড UI
    participant OAuth as /api/oauth/[provider]/[action]
    participant ProvAuth as প্রোভাইডার অথ সার্ভার
    participant DB as localDb
    participant Test as /api/providers/[id]/test
    participant Exec as প্রোভাইডার এক্সিকিউটর

    UI->>OAuth: GET অথরাইজ বা ডিভাইস-কোড
    OAuth->>ProvAuth: অথ/ডিভাইস ফ্লো তৈরি করুন
    ProvAuth-->>OAuth: অথ URL বা ডিভাইস কোড পেলোড
    OAuth-->>UI: ফ্লো ডেটা

    UI->>OAuth: POST এক্সচেঞ্জ বা পোল
    OAuth->>ProvAuth: টোকেন এক্সচেঞ্জ/পোল
    ProvAuth-->>OAuth: অ্যাক্সেস/রিফ্রেশ টোকেন
    OAuth->>DB: createProviderConnection(oauth ডেটা)
    OAuth-->>UI: সফল + কানেকশন id

    UI->>Test: POST /api/providers/[id]/test
    Test->>Exec: ক্রেডেনশিয়াল যাচাই / ঐচ্ছিক রিফ্রেশ
    Exec-->>Test: বৈধ বা রিফ্রেশ করা টোকেনের তথ্য
    Test->>DB: স্ট্যাটাস/টোকেন/ত্রুটি আপডেট করুন
    Test-->>UI: যাচাইয়ের ফলাফল
```
...
sequenceDiagram
    autonumber
    participant UI as এন্ডপয়েন্ট পেজ UI
    participant Sync as /api/sync/cloud
    participant DB as localDb
    participant Cloud as এক্সটার্নাল ক্লাউড সিঙ্ক
    participant Claude as ~/.claude/settings.json

    UI->>Sync: POST action=enable
    Sync->>DB: cloudEnabled=true সেট করুন
    Sync->>DB: API কী বিদ্যমান থাকা নিশ্চিত করুন
    Sync->>Cloud: POST /sync/{machineId} (প্রোভাইডার/অ্যালিয়াস/কম্বো/কী)
    Cloud-->>Sync: সিঙ্কের ফলাফল
    Sync->>Cloud: GET /{machineId}/v1/verify
    Sync-->>UI: সক্রিয় + যাচাইয়ের স্ট্যাটাস

    UI->>Sync: POST action=sync
    Sync->>Cloud: POST /sync/{machineId}
    Cloud-->>Sync: রিমোট ডেটা
    Sync->>DB: আরও নতুন লোকাল টোকেন/স্ট্যাটাস আপডেট করুন
    Sync-->>UI: সিঙ্ক সম্পন্ন

    UI->>Sync: POST action=disable
    Sync->>DB: cloudEnabled=false সেট করুন
    Sync->>Cloud: DELETE /sync/{machineId}
    Sync->>Claude: ANTHROPIC_BASE_URL আবার লোকালে পরিবর্তন করুন (প্রয়োজন হলে)
    Sync-->>UI: নিষ্ক্রিয়
```
