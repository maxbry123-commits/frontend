...
- [Prezzi in sintesi](#-pricing-at-a-glance)
- [Casi d'uso](#-use-cases)
- [Configurazione dei provider](#-provider-setup)
- [Integrazione con la CLI](#-cli-integration)
- [Distribuzione](#-deployment)
- [Modelli disponibili](#-available-models)
- [Funzionalità avanzate](#-advanced-features)
- [Instradamento automatico (senza configurazione)](#-auto-routing-zero-config)
- [Integrazione MCP e A2A](#-mcp--a2a-integration)
- [Sistema delle skill](#-skills-system)
- [Sistema di memoria](#-memory-system)
- [Webhook](#-webhooks)
- [Agenti cloud](#-cloud-agents)
- [Gestione programmatica](#-programmatic-management)
- [CLI interna](#-internal-cli)
- [Applicazione desktop (Electron)](#-desktop-application-electron)
...
<details>
<summary><b>Visualizza il template xbps-src</b></summary>
...
Per il riferimento completo delle variabili d'ambiente, consultare il [README](../README.md).
...
Il router automatico è descritto in dettaglio in [AUTO-COMBO.md](../routing/AUTO-COMBO.md), incluse le modalità per regolare i pesi dei punteggi, aggiungere provider alla lista nera e ispezionare le decisioni di instradamento in **Dashboard → Auto Combo**.
...
MCP definisce attualmente 32 ambiti denominati. Ogni chiave Bearer può essere limitata ad ambiti specifici; consultare [MCP-SERVER.md](../frameworks/MCP-SERVER.md) per l'elenco ufficiale degli ambiti e degli strumenti e [A2A-SERVER.md](../frameworks/A2A-SERVER.md) per lo schema JSON-RPC.
...
Documentazione completa: [SKILLS.md](../frameworks/SKILLS.md).
...
Gestisci le memorie da **Dashboard → Memory** (ricerca, modifica, esportazione, eliminazione). L'interfaccia HTTP (`/api/memory/*`) consente agli agenti di inviare e interrogare i fatti a livello di codice — consulta [MEMORY.md](../frameworks/MEMORY.md).
...
Schema completo in [WEBHOOKS.md](../frameworks/WEBHOOKS.md).
...
Documentazione completa: [CLOUD_AGENT.md](../frameworks/CLOUD_AGENT.md).
...
Consulta [API_REFERENCE.md](../reference/API_REFERENCE.md) per il catalogo completo degli endpoint e gli schemi di richiesta/risposta.
