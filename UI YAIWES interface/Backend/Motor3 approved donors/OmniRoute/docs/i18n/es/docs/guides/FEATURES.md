...
📚 **Documentación relacionada:** [Marco de habilidades](../frameworks/SKILLS.md) · [Sistema de memoria](../frameworks/MEMORY.md) · [Agentes en la nube](../frameworks/CLOUD_AGENT.md) · [Webhooks](../frameworks/WEBHOOKS.md) · [Caché de reproducción de razonamiento](../routing/REASONING_REPLAY.md)
...
![Panel de proveedores](../screenshots/01-providers.png)
...
- **Plantillas de prompts del sistema** — el `system_message` del combo admite los marcadores de posición del lado del servidor
  `{{MODEL_ID}}`, `{{PROVIDER_ID}}`, `{{ACCOUNT}}` y `{{FINGERPRINT}}`,
  que se expanden a partir del destino al que realmente se ha enrutado justo antes del envío.
  Se usa una lista de permitidos y no son recursivos; los marcadores de posición desconocidos permanecen literales; los valores vacíos
  se expanden como vacíos; los prompts del sistema del cliente nunca se reescriben. `{{FINGERPRINT}}`
  solo se resuelve para proveedores gratuitos basados en huellas digitales con una huella fijada o
  rotada automáticamente; en otros casos se expande como vacío (por ejemplo,
  conexiones con una única huella digital o proveedores que no utilizan huellas digitales). La expansión abarca el
  bucle de envío estándar, round-robin y las sesiones fijadas de caché de contexto;
  las estrategias fusion, chaos, pipeline y nested-execute todavía no expanden
  los marcadores de posición.

![Panel de combos](../screenshots/02-combos.png)
...
![Panel de análisis](../screenshots/03-analytics.png)
...
![Panel de estado](../screenshots/04-health.png)
...
![Área de pruebas del traductor](../screenshots/05-translator.png)

---

## 🎮 Área de pruebas de modelos _(v2.0.9+)_
...
![Panel de configuración](../screenshots/06-settings.png)
...
![Panel de herramientas de CLI](../screenshots/07-cli-tools.png)
...
Actualmente admite la rotación de cuentas de Codex. Consulta la [documentación de Context Relay](../architecture/ARCHITECTURE.md).

---

## 🗜️ Compresión de prompts _(v3.7.9+)_
...
Consulta la [Guía de compresión](../compression/COMPRESSION_GUIDE.md), [Compresión RTK](../compression/RTK_COMPRESSION.md) y
[Motores de compresión](../compression/COMPRESSION_ENGINES.md).

---

## 🛡️ Refuerzo del proxy _(v3.5.5+)_
...
## 📧 Enmascaramiento de privacidad del correo electrónico _(v3.5.6+)_
...
## 👁️ Control de visibilidad de modelos _(v3.5.6+)_
...
## 🗑️ Desinstalación / Desinstalación completa _(v3.6.2+)_
...
## 🖼️ Contenido multimedia _(v2.0.3+)_
...
![Registros de uso](../screenshots/08-usage.png)
...
![Panel de endpoints](../screenshots/09-endpoint.png)
...
## 🔑 Tokens de sincronización y paquete de configuración _(v3.6.6+)_
...
## 🧠 Preajuste de razonamiento GLM _(v3.6.6+)_
...
## 🔄 Reintentos que tienen en cuenta el período de espera _(v3.6.6+)_
...
## 📋 Auditoría de cumplimiento v2 _(v3.6.6+)_
