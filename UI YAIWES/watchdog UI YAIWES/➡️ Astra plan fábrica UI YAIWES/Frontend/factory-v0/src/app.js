...
function setTab(name){
  ...
  document.querySelectorAll('[data-config-tab]').forEach(b=>{ const active=b.dataset.configTab===name; b.classList.toggle('active',active); b.setAttribute('aria-selected',String(active)); });
}
...
$('team-mode').value=config.teamMode; $('theme-bg').value=config.theme.bg;$('theme-panel-color').value=config.theme.panel;$('theme-text').value=config.theme.text;$('theme-accent').value=config.theme.accent;$('theme-radius').value=config.theme.radius;applyTheme();renderConfigLists();setTab('router');render();
