...
Destino: `UI YAIWES/➡️📂 Wordflow LOOP UI YAIWES/runtime/vendor`. Fuente central inmutable; materialización sin reescritura de blobs.

|#|Componente|Estado|Destino|
|---:|---|---|---|
|1|Stabilize CORE|ALREADY_VENDOR|`UI YAIWES/➡️📂 Wordflow LOOP UI YAIWES/runtime/vendor/stabilize`|
|2|Pydantic|ALREADY_VENDOR|`UI YAIWES/➡️📂 Wordflow LOOP UI YAIWES/runtime/vendor/pydantic`|
