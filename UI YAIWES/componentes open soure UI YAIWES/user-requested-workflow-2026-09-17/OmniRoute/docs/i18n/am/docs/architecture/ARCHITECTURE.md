...
🌐 **Languages:** 🇺🇸 [English](../../../../architecture/ARCHITECTURE.md) · 🇸🇦 [ar](../../../ar/docs/architecture/ARCHITECTURE.md) · 🇦🇿 [az](../../../az/docs/architecture/ARCHITECTURE.md) · 🇧🇬 [bg](../../../bg/docs/architecture/ARCHITECTURE.md) · 🇧🇩 [bn](../../../bn/docs/architecture/ARCHITECTURE.md) · 🇨🇿 [cs](../../../cs/docs/architecture/ARCHITECTURE.md) · 🇩🇰 [da](../../../da/docs/architecture/ARCHITECTURE.md) · 🇩🇪 [de](../../../de/docs/architecture/ARCHITECTURE.md) · 🇬🇷 [el](../../../el/docs/architecture/ARCHITECTURE.md) · 🇪🇸 [es](../../../es/docs/architecture/ARCHITECTURE.md) · 🇪🇪 [et](../../../et/docs/architecture/ARCHITECTURE.md) · 🇮🇷 [fa](../../../fa/docs/architecture/ARCHITECTURE.md) · 🇫🇮 [fi](../../../fi/docs/architecture/ARCHITECTURE.md) · 🇫🇷 [fr](../../../fr/docs/architecture/ARCHITECTURE.md) · 🇮🇪 [ga](../../../ga/docs/architecture/ARCHITECTURE.md) · 🇮🇳 [gu](../../../gu/docs/architecture/ARCHITECTURE.md) · 🇳🇬 [ha](../../../ha/docs/architecture/ARCHITECTURE.md) · 🇮🇱 [he](../../../he/docs/architecture/ARCHITECTURE.md) · 🇮🇳 [hi](../../../hi/docs/architecture/ARCHITECTURE.md) · 🇭🇷 [hr](../../../hr/docs/architecture/ARCHITECTURE.md) · 🇭🇺 [hu](../../../hu/docs/architecture/ARCHITECTURE.md) · 🇦🇲 [hy](../../../hy/docs/architecture/ARCHITECTURE.md) · 🇮🇩 [id](../../../id/docs/architecture/ARCHITECTURE.md) · 🇳🇬 [ig](../../../ig/docs/architecture/ARCHITECTURE.md) · 🇮🇹 [it](../../../it/docs/architecture/ARCHITECTURE.md) · 🇯🇵 [ja](../../../ja/docs/architecture/ARCHITECTURE.md) · 🇬🇪 [ka](../../../ka/docs/architecture/ARCHITECTURE.md) · 🇰🇭 [km](../../../km/docs/architecture/ARCHITECTURE.md) · 🇮🇳 [kn](../../../kn/docs/architecture/ARCHITECTURE.md) · 🇰🇷 [ko](../../../ko/docs/architecture/ARCHITECTURE.md) · 🇱🇹 [lt](../../../lt/docs/architecture/ARCHITECTURE.md) · 🇱🇻 [lv](../../../lv/docs/architecture/ARCHITECTURE.md) · 🇮🇳 [ml](../../../ml/docs/architecture/ARCHITECTURE.md) · 🇮🇳 [mr](../../../mr/docs/architecture/ARCHITECTURE.md) · 🇲🇾 [ms](../../../ms/docs/architecture/ARCHITECTURE.md) · 🇲🇹 [mt](../../../mt/docs/architecture/ARCHITECTURE.md) · 🇲🇲 [my](../../../my/docs/architecture/ARCHITECTURE.md) · 🇳🇵 [ne](../../../ne/docs/architecture/ARCHITECTURE.md) · 🇳🇱 [nl](../../../nl/docs/architecture/ARCHITECTURE.md) · 🇳🇴 [no](../../../no/docs/architecture/ARCHITECTURE.md) · 🇮🇳 [or](../../../or/docs/architecture/ARCHITECTURE.md) · 🇮🇳 [pa](../../../pa/docs/architecture/ARCHITECTURE.md) · 🇵🇭 [phi](../../../phi/docs/architecture/ARCHITECTURE.md) · 🇵🇱 [pl](../../../pl/docs/architecture/ARCHITECTURE.md) · 🇵🇹 [pt](../../../pt/docs/architecture/ARCHITECTURE.md) · 🇧🇷 [pt-BR](../../../pt-BR/docs/architecture/ARCHITECTURE.md) · 🇷🇴 [ro](../../../ro/docs/architecture/ARCHITECTURE.md) · 🇷🇺 [ru](../../../ru/docs/architecture/ARCHITECTURE.md) · 🇱🇰 [si](../../../si/docs/architecture/ARCHITECTURE.md) · 🇸🇰 [sk](../../../sk/docs/architecture/ARCHITECTURE.md) · 🇸🇮 [sl](../../../sl/docs/architecture/ARCHITECTURE.md) · 🇷🇸 [sr](../../../sr/docs/architecture/ARCHITECTURE.md) · 🇸🇪 [sv](../../../sv/docs/architecture/ARCHITECTURE.md) · 🇰🇪 [sw](../../../sw/docs/architecture/ARCHITECTURE.md) · 🇮🇳 [ta](../../../ta/docs/architecture/ARCHITECTURE.md) · 🇮🇳 [te](../../../te/docs/architecture/ARCHITECTURE.md) · 🇹🇭 [th](../../../th/docs/architecture/ARCHITECTURE.md) · 🇹🇷 [tr](../../../tr/docs/architecture/ARCHITECTURE.md) · 🇺🇦 [uk-UA](../../../uk-UA/docs/architecture/ARCHITECTURE.md) · 🇵🇰 [ur](../../../ur/docs/architecture/ARCHITECTURE.md) · 🇺🇿 [uz](../../../uz/docs/architecture/ARCHITECTURE.md) · 🇻🇳 [vi](../../../vi/docs/architecture/ARCHITECTURE.md) · 🇳🇬 [yo](../../../yo/docs/architecture/ARCHITECTURE.md) · 🇨🇳 [zh-CN](../../../zh-CN/docs/architecture/ARCHITECTURE.md) · 🇹🇼 [zh-TW](../../../zh-TW/docs/architecture/ARCHITECTURE.md)
...
![ባለ3-ንብርብር የመቋቋም ሞዴል](../diagrams/exported/resilience-3layers.svg)
...
```mermaid
flowchart LR
    subgraph Clients[የገንቢ ደንበኞች]
        C1[Claude Code]
        C2[Codex CLI]
        C3[OpenClaw / Droid / Cline / Continue / Roo]
        C4[ከOpenAI ጋር ተኳኋኝ የሆኑ ብጁ ደንበኞች]
        BROWSER[የአሳሽ ዳሽቦርድ]
    end

    subgraph Router[OmniRoute አካባቢያዊ ሂደት]
        API[V1 የተኳኋኝነት API\n/v1/*]
        DASH[ዳሽቦርድ + የአስተዳደር API\n/api/*]
        CORE[SSE + የትርጉም ዋና ክፍል\nopen-sse + src/sse]
        DB[(storage.sqlite)]
        UDB[(የአጠቃቀም ሰንጠረዦች + የምዝግብ ማስረጃዎች)]
    end

    subgraph Upstreams[የላይኛ ፍሰት አቅራቢዎች]
        P1[OAuth አቅራቢዎች\nClaude/Codex/Gemini/Qoder/GitHub/Kiro/Cursor/Antigravity]
        P2[የAPI ቁልፍ አቅራቢዎች\nOpenAI/Anthropic/OpenRouter/GLM/Kimi/MiniMax\nDeepSeek/Groq/xAI/Mistral/Perplexity\nTogether/Fireworks/Cerebras/Cohere/NVIDIA]
        P3[ተኳኋኝ ኖዶች\nከOpenAI ጋር ተኳኋኝ / ከAnthropic ጋር ተኳኋኝ]
    end

    subgraph Cloud[አማራጭ የደመና ማመሳሰል]
        CLOUD[የደመና ማመሳሰል መጨረሻ ነጥብ\nNEXT_PUBLIC_CLOUD_URL]
    end
...
```mermaid
flowchart TD
    A[የገባ የሞዴል ሕብረቁምፊ] --> B{የጥምር ስም ነው?}
    B -- አዎ --> C[የጥምር ሞዴሎችን ቅደም ተከተል ጫን]
    B -- አይ --> D[የነጠላ ሞዴል መንገድ]

    C --> E[ሞዴል Nን ሞክር]
    E --> F[አቅራቢ/ሞዴልን ፈትሽ]
    D --> F

    F --> G[የመለያ ማረጋገጫዎችን ምረጥ]
    G --> H{ማረጋገጫዎች ይገኛሉ?}
    H -- አይ --> I[አቅራቢው እንደማይገኝ መልስ]
    H -- አዎ --> J[ጥያቄውን አስፈጽም]

    J --> K{ተሳክቷል?}
    K -- አዎ --> L[ምላሹን መልስ]
    K -- አይ --> M{ስህተቱ ለተተኪ ብቁ ነው?}

    M -- አይ --> N[ስህተቱን መልስ]
    M -- አዎ --> O[መለያውን ለማቀዝቀዣ ጊዜው የማይገኝ አድርገህ ምልክት አድርግ]
    O --> P{ለአቅራቢው ሌላ መለያ አለ?}
    P -- አዎ --> G
    P -- አይ --> Q{በጥምሩ ውስጥ ቀጣይ ሞዴል አለ?}
    Q -- አዎ --> E
    Q -- አይ --> R[ሁሉም እንደማይገኙ መልስ]
```
...
sequenceDiagram
    autonumber
    participant UI as ዳሽቦርድ UI
    participant OAuth as /api/oauth/[provider]/[action]
    participant ProvAuth as የአቅራቢ ማረጋገጫ አገልጋይ
    participant DB as localDb
    participant Test as /api/providers/[id]/test
    participant Exec as የአቅራቢ አስፈጻሚ

    UI->>OAuth: GET authorize ወይም device-code
    OAuth->>ProvAuth: የማረጋገጫ/መሣሪያ ፍሰት ፍጠር
    ProvAuth-->>OAuth: የማረጋገጫ URL ወይም የመሣሪያ ኮድ ውሂብ
    OAuth-->>UI: የፍሰት ውሂብ

    UI->>OAuth: POST exchange ወይም poll
    OAuth->>ProvAuth: የቶከን ልውውጥ/የሁኔታ ጥያቄ
    ProvAuth-->>OAuth: የመዳረሻ/ማደሻ ቶከኖች
    OAuth->>DB: createProviderConnection(oauth data)
    OAuth-->>UI: ስኬት + የግንኙነት id

    UI->>Test: POST /api/providers/[id]/test
    Test->>Exec: ማረጋገጫዎችን አረጋግጥ / አማራጭ ማደሻ
    Exec-->>Test: ትክክለኛ ወይም የታደሰ የቶከን መረጃ
    Test->>DB: ሁኔታን/ቶከኖችን/ስህተቶችን አዘምን
    Test-->>UI: የማረጋገጫ ውጤት
```
...
sequenceDiagram
    autonumber
    participant UI as የመጨረሻ ነጥብ ገጽ UI
    participant Sync as /api/sync/cloud
    participant DB as localDb
    participant Cloud as ውጫዊ የደመና ማመሳሰል
    participant Claude as ~/.claude/settings.json

    UI->>Sync: POST action=enable
    Sync->>DB: cloudEnabled=true አድርግ
    Sync->>DB: API key መኖሩን አረጋግጥ
    Sync->>Cloud: POST /sync/{machineId} (አቅራቢዎች/ተለዋጭ ስሞች/ጥምሮች/ቁልፎች)
    Cloud-->>Sync: የማመሳሰል ውጤት
    Sync->>Cloud: GET /{machineId}/v1/verify
    Sync-->>UI: ነቅቷል + የማረጋገጫ ሁኔታ

    UI->>Sync: POST action=sync
    Sync->>Cloud: POST /sync/{machineId}
    Cloud-->>Sync: የርቀት ውሂብ
    Sync->>DB: አዳዲስ የአካባቢ ቶከኖችን/ሁኔታን አዘምን
    Sync-->>UI: ተመሳስሏል

    UI->>Sync: POST action=disable
    Sync->>DB: cloudEnabled=false አድርግ
    Sync->>Cloud: DELETE /sync/{machineId}
    Sync->>Claude: ANTHROPIC_BASE_URLን ወደ አካባቢያዊው መልስ (አስፈላጊ ከሆነ)
    Sync-->>UI: ተሰናክሏል
```
...
```mermaid
flowchart LR
    subgraph LocalHost[የገንቢ አስተናጋጅ]
        CLI[CLI መሣሪያዎች]
        Browser[የዳሽቦርድ አሳሽ]
    end

    subgraph ContainerOrProcess[OmniRoute የአሂድ ጊዜ]
        Next[Next.js አገልጋይ\nPORT=20128]
        Core[SSE ኮር + አስፈጻሚዎች]
        MainDB[(storage.sqlite)]
        UsageDB[(የአጠቃቀም ሰንጠረዦች + የምዝግብ ቅርሶች)]
    end

    subgraph External[ውጫዊ አገልግሎቶች]
        Providers[AI አቅራቢዎች]
        SyncCloud[የደመና ማመሳሰል አገልግሎት]
    end
