...
- a portfolio site
- a startup site where visual quality matters heavily
...
- then implement the full site from those 8 section images
...
- then implement the site from those 4 images
