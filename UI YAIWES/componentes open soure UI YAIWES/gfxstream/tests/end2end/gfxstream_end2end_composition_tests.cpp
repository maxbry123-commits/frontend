...
TEST_P(GfxstreamEnd2EndCompositionTest, BlitYCbCr888420) {
    constexpr const uint32_t kWidth = 32;
    constexpr const uint32_t kHeight = 32;
    ...
    const auto yuvAhb = GFXSTREAM_ASSERT(
        CreateAHBWithColor(kWidth, kHeight, GFXSTREAM_AHB_FORMAT_Y8Cb8Cr8_420, yuvColor));
...
TEST_P(GfxstreamEnd2EndCompositionTest, BasicCompositionYCbCr888420) {
    ScopedRenderControlDevice rcDevice(*mRc);
    ...
    const auto layer2YuvColor = PixelY8U8V8::FromR8G8B8A8(layer2RgbaColor);
    auto layer2Ahb =
        GFXSTREAM_ASSERT(CreateAHBWithColor(32, 32, GFXSTREAM_AHB_FORMAT_Y8Cb8Cr8_420, layer2YuvColor));
...
TEST_P(GfxstreamEnd2EndCompositionTest, RotatedCompositionYCbCr888420) {
    ScopedRenderControlDevice rcDevice(*mRc);
    ...
    auto layer1Ahb = GFXSTREAM_ASSERT(CreateAHBFromImage("256x256_android.png"));
    auto layer2Ahb = GFXSTREAM_ASSERT(
        CreateAHBWithCheckerboard(256, 256, 64, GFXSTREAM_AHB_FORMAT_Y8Cb8Cr8_420, yuvColor1, yuvColor2));
    auto resultAhb = GFXSTREAM_ASSERT(
        ScopedAHardwareBuffer::Allocate(*mGralloc, 256, 256, GFXSTREAM_AHB_FORMAT_R8G8B8A8_UNORM));
