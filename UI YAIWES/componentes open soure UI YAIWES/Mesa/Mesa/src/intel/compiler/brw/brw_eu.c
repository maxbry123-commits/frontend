...
static const struct opcode_desc opcode_descs[] = {
   ...
   { BRW_OPCODE_SENDG,    51,  "sendg",   2,    1,    GFX_GE(XE3P) },
   ...
   { BRW_OPCODE_MULLH,    95,  "mullh",   2,    1,    GFX_GE(XE3P) },
   ...
   { BRW_OPCODE_MAC,      72,  "mac",     2,    1,    GFX_LT(XE3P) },
   { BRW_OPCODE_MACH,     73,  "mach",    2,    1,    GFX_LT(XE3P) },
   ...
   { BRW_OPCODE_MACL,     83,  "macl",    2,    1,    XE2|XE3 },
