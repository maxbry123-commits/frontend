...
* **android:** AGP 9.0 no longer supporting `proguard-android.txt` ([#67](https://github.com/ionic-team/capacitor-filesystem/issues/67)) ([eb16000](https://github.com/ionic-team/capacitor-filesystem/commit/eb16000cb672f49e9609347c343d09a1ebf895d5))
...
# [7.1.0](https://github.com/ionic-team/capacitor-filesystem/tree/v7.1.0) (2025-05-26)

### Deprecations

- `downloadFile`, `addListener`, `removeAllListeners` have now been marked deprecated; we recommend using the new [@capacitor/file-transfer plugin](https://github.com/ionic-team/capacitor-file-transfer) in conjunction with this 
