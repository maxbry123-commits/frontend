...
- [x] Paleta warm documentada  
- [x] 4 variantes título/fondo en artifacts  
- [x] i18n 4 idiomas en plan  
- [x] Parallel tasks diseño  
- [x] Comms + YT + search OS investigados  
- [x] Dual local/web  
- [x] Plan fases A–D + download determinista  
- [ ] Ejecutar T-01 repo cuando usuario ordene  
