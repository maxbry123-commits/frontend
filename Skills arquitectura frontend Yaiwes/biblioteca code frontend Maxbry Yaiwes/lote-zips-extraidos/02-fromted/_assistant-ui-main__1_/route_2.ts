...
- "ChatGPT": Dark theme inspired by ChatGPT's interface (dark theme, green accent #2563eb, full border radius, feedback enabled, avatars)
- "Claude": Warm, elegant design inspired by Claude's interface (light theme, warm brown accent #2563eb, serif font, spacious, reasoning enabled)
- "Perplexity": Search-focused design with prominent answers (dark theme, cyan accent #2563eb, left-aligned user messages, follow-up suggestions)
...
- "Gemini": Google's Gemini-inspired clean interface (light, blue accent #2563eb, full border radius, suggestions + follow-ups)
- "Copilot": GitHub Copilot inspired developer chat (dark, purple accent #2563eb, monospace font, compact, one-dark-pro code theme)
- "Slack": Team chat inspired collaborative interface (light, green accent #2563eb, left-aligned, compact, small border radius, no animations)
