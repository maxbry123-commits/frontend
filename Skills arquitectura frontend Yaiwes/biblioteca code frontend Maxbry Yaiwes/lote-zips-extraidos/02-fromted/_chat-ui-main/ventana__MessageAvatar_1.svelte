...
>
	<g clip-path="url(#a)">
		<!-- circular mask -->
		<path d="M12 6A6 6 0 1 0 0 6a6 6 0 0 0 12 0Z" fill="#ffffff" />
		...
		<g filter="url(#c)" mask="url(#b)">
			...
			<path id="blob" fill="#0a0a0d" d="M11 1 L8 -4 L3 -8 L-6 6 L3 12 L7 11 L6 2 L11 1 Z">
	...
	<defs>
		<clipPath id="a"><path fill="#ffffff" d="M0 0h12v12H0z" /></clipPath>
		<filter
			id="c"
			x="-9.4"
			y="-10.8"
