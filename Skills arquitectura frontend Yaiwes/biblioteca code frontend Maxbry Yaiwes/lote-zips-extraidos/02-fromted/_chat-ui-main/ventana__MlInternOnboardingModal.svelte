...
<Modal onclose={close} labelledBy="ml-intern-onboarding-title" width="max-w-[440px]! m-4!">
	...
	>
		...
		>
			<div
				class="grid size-14 place-items-center rounded-full bg-[#ffffff] text-[#2563eb] dark:bg-[#2563eb] dark:text-[#2563eb]"
			>
			...
			<li class="flex gap-3.5">
				...
				<div class="flex flex-col gap-1.5">
					...
					<a
						...
						class="inline-flex items-center gap-1 self-start text-sm font-medium text-[#2563eb] underline decoration-[#2563eb]/30 underline-offset-2 hover:decoration-[#2563eb] dark:text-[#2563eb] dark:decoration-[#2563eb]/30 dark:hover:decoration-[#2563eb]"
					>
						Open MCP settings
