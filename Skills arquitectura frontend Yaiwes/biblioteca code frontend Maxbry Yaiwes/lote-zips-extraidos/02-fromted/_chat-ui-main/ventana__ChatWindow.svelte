					...
					{#each activeExamples as ex}
						<button
							class={[
								...
								mlModeOn
									? "bg-[#ffffff] text-[#2563eb] dark:bg-[#2563eb] dark:text-[#2563eb]"
			...
			<div class="w-full">
				...
				<form
					...
					class={{
						...
						"border-[#ffffff] dark:border-[#141417]": mlModeOn && (mlStripVisible || mlPillVisible),
...
<style>
	...
	@keyframes glow {
		...
		50% {
			box-shadow: 0 0 20px 4px rgba(37,99,235,0.6);
		}
		100% {
	...
	.router-shimmer {
		...
		background-image: linear-gradient(
			90deg,
			rgba(161,161,170,1) 0%,
			rgba(161,161,170,0.6) 10%,
			rgba(161,161,170,0.6) 50%,
			rgba(161,161,170,0.6) 90%,
