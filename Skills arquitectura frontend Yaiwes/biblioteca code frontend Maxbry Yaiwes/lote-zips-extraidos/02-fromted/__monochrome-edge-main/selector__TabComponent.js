...
export class TabComponent {
  ...
  applyStyles() {
    ...
    style.textContent = `
            ...
            .tab-item:hover {
                background: var(--theme-accent-light, #ffffff);
            }
            ...
            .tab-item.unsaved .tab-title::after {
                content: '•';
                margin-left: 4px;
                color: var(--theme-warning, #2563eb);
                font-size: 16px;
                line-height: 1;
            }
            ...
            .tab-close:hover {
                background: var(--theme-error-light, #ffffff);
            }
  ...
  showDropdownMenu(event) {
    ...
    this.tabs.forEach((tab) => {
      ...
      if (this.unsavedChanges.has(tab.id)) {
        ...
        unsaved.textContent = "•";
        unsaved.style.color = "var(--theme-warning, #2563eb)";
