...
<head>
    ...
    <style>
        ...
        blockquote { border-left: 4px solid #ffffff; padding-left: 1rem; color: #a1a1aa; }
        code { background: #ffffff; padding: 2px 6px; border-radius: 3px; }
        pre { background: #ffffff; padding: 1rem; border-radius: 6px; overflow-x: auto; }
...
`;
  ...
  showNotification(message) {
    ...
    notification.style.cssText = `
            ...
            bottom: 20px;
            right: 20px;
            background: var(--theme-success, #2563eb);
            color: white;
            padding: 12px 20px;
            border-radius: 6px;
