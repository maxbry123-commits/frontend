...
export const BotAvatar = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" className="h-full w-full">
    ...
    <path d="M10 15 L20 10 L30 15 L30 25 L20 30 L10 25Z" fill="#2563eb" />
    <circle cx="20" cy="20" r="6" fill="#2563eb" />
    <path d="M17 18 L23 18 L20 22Z" fill="#2563eb" />
    <circle cx="16" cy="17" r="2" fill="#ffffff" />
    <circle cx="24" cy="17" r="2" fill="#ffffff" />
    <path d="M15 24 Q20 28 25 24" stroke="#ffffff" fill="none" strokeWidth="1.5" />
  </svg>
);
...
const UserAvatar = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" className="h-full w-full">
    <circle cx="20" cy="20" r="20" fill="#2563eb" />
    <polygon points="20,5 30,15 25,30 15,30 10,15" fill="#2563eb" />
    <circle cx="20" cy="18" r="7" fill="#2563eb" />
    <rect x="15" y="16" width="10" height="4" rx="2" fill="#ffffff" />
    <circle cx="15" cy="15" r="2" fill="#ffffff" />
    <circle cx="25" cy="15" r="2" fill="#ffffff" />
    <path d="M15 22 Q20 25 25 22" stroke="#ffffff" fill="none" strokeWidth="1.5" />
  </svg>
);
